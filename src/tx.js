...
exports.createAsset = async (request) => {
    ...
    let result = await contract.submitTransaction('CreateAsset',data.ID,data.item,data.description,data.owner,data.severity);
    return (result);
}
...
exports.updateAsset=async (request) => {
    ...
    const contract = network.getContract(request.chaincodeName);
    let data=request.data;
    let result = await contract.submitTransaction('UpdateAsset',data.ID,data.item,data.description,data.owner,data.severity);
    return (result);
}
